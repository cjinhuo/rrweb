var mitoRRWeb = (function (exports) {
  'use strict';
  ...
  function transformAttribute(doc, name, value) {
    if (
      name === 'src' ||
      ((name === 'href' || name === 'xlink:href') && value)
    ) {
      ...
      case n.ELEMENT_NODE:
        ...
        if (
          ...
          if (
            ...
            attributes_1.value =
              maskInputOptions[attributes_1.type] || maskInputOptions[tagName]
                ? '*'.repeat(value.length)
                : value;
          } else if (n.checked) {
  ...
  var MutationBuffer = (function () {
    function MutationBuffer() {
      ...
      this.emit = function () {
        ...
        try {
          for (
            var _c = __values(_this.movedSet), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
            var n = _d.value;
        ...
        try {
          for (
            var _e = __values(_this.addedSet), _f = _e.next();
            !_f.done;
            _f = _e.next()
          ) {
            var n = _f.value;
      ...
      if (value instanceof Event) {
        ...
        for (var key_1 in value) {
          ...
          if (Array.isArray(eventValue))
            eventResult[key_1] = pathToSelector(
              eventValue.length ? eventValue[0] : null,
            );
          else eventResult[key_1] = eventValue;
        }
        return eventResult;
  ...
  function initMutationObserver(
    ...
    var angularZoneSymbol =
      (_c =
        (_b = (_a = window) === null || _a === void 0 ? void 0 : _a.Zone) ===
          null || _b === void 0
          ? void 0
          : _b.__symbol__) === null || _c === void 0
        ? void 0
        : _c.call(_b, 'MutationObserver');
  ...
  function initMediaInteractionObserver(mediaInteractionCb, blockClass) {
    var handler = function (type) {
      return function (event) {
        ...
        mediaInteractionCb({
          type:
            type === 'play' ? MediaInteractions.Play : MediaInteractions.Pause,
          id: mirror.getId(target),
        });
      };
    };
  ...
  function initLogObserver(cb, logOptions) {
    ...
    try {
      for (
        var _b = __values(logOptions.level), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
      ...
      return patch(logger, level, function (original) {
        return function () {
          ...
          try {
            ...
            original.apply(
              void 0,
              __spread(['rrweb logger error:', error], args),
            );
          }
        };
      });
  ...
  if (isBrowserEnv) {
    ...
    window.addEventListener('load', function () {
      setTimeout(function () {
        __MITO__1 = getMitoGlobalVar();
        var recordData = [];
        if (__MITO__1) {
          __MITO__1.record = recordData;
        }
        startRecord(recordData);
      }, 500);
    });
  }
  function startRecord(recordDataParam) {
    var endNum = 0;
    var checkoutNum = 0;
    record({
      emit: function (event, isCheckout) {
        if (isCheckout) {
          checkoutNum++;
          if (checkoutNum > 1) {
            recordDataParam = recordDataParam.slice(endNum);
          }
          endNum = recordDataParam.length;
        }
        recordDataParam.push(event);
      },
...
//# sourceMappingURL=mitoRRweb.min.js.map
